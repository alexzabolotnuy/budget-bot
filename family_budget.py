...
CATEGORIES = [
    "Оренда", "Няня/Садок", "Інвестиції", "Накопичення",
    "Харчування + Побут/гігієна", "Податки", "Спорт",
    "Шопінг", "Авто(бенз)", "Розваги/заклади",
    "Резерв непередбачування", "Медецина"
]
...
CATEGORY_LIMITS = {
    ...
    "Інвестиції": 2700,
    "Накопичення": 1000,
    "Харчування + Побут/гігієна": 2500,
    "Податки": 1200,
    "Спорт": 500,
    "Шопінг": 800,
    "Авто(бенз)": 600,
    "Розваги/заклади": 700,
    "Резерв непередбачування": 300,
    "Медецина": 400
}
